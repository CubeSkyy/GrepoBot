var Autobot = {
    ...
    scriptDomain: window["location"]["protocol"] + "//cdn.jsdelivr.net/gh/CubeSkyy/GrepoBot@main/",
    //scriptDomain: window["location"]["protocol"] + "//cdn.jsdelivr.net/gh/gdrakoul/grepobot-cracked@v5.1/",
    botWnd: "",
    botPremWnd: "",
    botEmailWnd: "",
    facebookWnd: "",
        ...
        if (window != undefined) {
            if ($(".nui_main_menu")["length"] && !$["isEmptyObject"](ITowns["towns"])) {
                ...
                if (/grepolis\.com\/start\?nosession/g ["test"](window["location"]["href"])) {
                    clearInterval(loadIntervalID);
                    $["getScript"](Autobot["scriptDomain"] + "Evaluate.js", function() {
                        $["when"]($["getScript"](Autobot["scriptDomain"] + "DataExchanger.js"), $["getScript"](Autobot["scriptDomain"] + "Redirect.js"), $.Deferred(function(_0x88b7x44) {
                            $(_0x88b7x44["resolve"])
                        }))["done"](function() {
